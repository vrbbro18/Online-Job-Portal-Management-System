  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $stmt = $connection->prepare("INSERT INTO creat_a_gig (title, category, description, delivery_time, number_of_revisions, tags, gig_extras, basic_price, standered_price, premium_price) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
      $stmt->bind_param("ssssssssss", $title, $category, $description, $deliverytime, $numberofrevisions, $tags, $gigextras, $basicprice, $standeredprice, $premiumprice);
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Creat a gig</title>
    
    <script src="https://kit.fontawesome.com/a076d05399.js"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" type="text/css" href="style/creatgig.css">
...
<form action="creatgig.php" class="gigform" method="post">
    <div class="gform">
